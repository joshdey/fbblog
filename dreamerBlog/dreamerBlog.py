...
if __name__ == '__main__':
    ...
    st.markdown("<img src = 'https://github.com/joshdey/fbblog/blob/main/dreamerBlog/DreamerMNISTRun1.100.png' style='width:210px;height:50px;'>",unsafe_allow_html=True)
    #st.image('https://github.com/joshdey/fbblog/blob/main/dreamerBlog/DreamerMNISTRun1.100.png', caption='The moving average of the reward at the beginning of the run lies around 7.5, indicating roughly a 50/50 split between moving down either of the two paths and as the training time increases it slowly approaches 9.5 indicating a policy of choosing the path leading to a higher reward and increasing number of times.')
