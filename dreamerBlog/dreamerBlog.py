...
if __name__ == '__main__':
    ...
    st.write('Below you can see some plots comparing the performance of Dreamerv2 on various Atari games to show that it does outperform various model-free and model-based methods. **Input Images**')
